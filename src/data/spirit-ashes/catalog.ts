...
const LOCATION_DATA: Record<string, LocationData> = {
  ...
  'Nomad Ashes': { location: 'Subterranean Shunning-Grounds', region: 'Leyndell, Royal Capital', source: 'Found on a corpse in the Subterranean Shunning-Grounds.' },
  'Putrid Corpse Ashes': { location: 'Gaol Cave', region: 'Caelid', source: 'Dropped by the Frenzied Duelist in Gaol Cave.' },
  ...
  'Albinauric Ashes': { location: 'Caria Manor Graveyard', region: 'Liurnia of the Lakes', source: 'Found on a corpse in the graveyard east of Caria Manor.' },
  'Winged Misbegotten Ashes': { location: 'Unsightly Catacombs', region: 'Altus Plateau', source: 'Found in a pit in Unsightly Catacombs.' },
  'Demi-Human Ashes': { location: 'Impaler\'s Catacombs', region: 'Weeping Peninsula', source: 'Found in Impaler\'s Catacombs.' },
  'Clayman Ashes': { location: 'Ainsel River Main', region: 'Liurnia of the Lakes', source: 'Found on a body beside a waterfall in Ainsel River Main.' },
  'Oracle Envoy Ashes': { location: 'Haligtree Town', region: "Miquella's Haligtree", source: 'Found on a body guarded by Oracle Envoys near Haligtree Town.' },
  'Lone Wolf Ashes': { location: 'Church of Elleh', region: 'Limgrave', source: 'Given by Renna at the Church of Elleh.' },
  'Rotten Stray Ashes': { location: 'Sellia Under-Stair', region: 'Caelid', source: 'Found on a corpse south of the Sellia Under-Stair Site of Grace.' },
  'Giant Rat Ashes': { location: 'West Windmill Pasture', region: 'Altus Plateau', source: 'Found inside the stable at West Windmill Pasture.' },
  'Warhawk Ashes': { location: 'Stormveil Castle', region: 'Limgrave', source: 'Found in Stormveil Castle.' },
  'Land Squirt Ashes': { location: 'Eastern Liurnia Lake Shore', region: 'Liurnia of the Lakes', source: 'Found on a body at a grave south of the Eastern Liurnia Lake Shore.' },
  'Spirit Jellyfish Ashes': { location: 'Stormhill Shack', region: 'Limgrave', source: 'Given by Roderika at Stormhill Shack.' },
  'Miranda Sprout Ashes': { location: 'Caelid Catacombs', region: 'Caelid', source: 'Found behind an illusory wall in Caelid Catacombs.' },
  'Fanged Imp Ashes': { location: 'Raya Lucaria Academy', region: 'Liurnia of the Lakes', source: 'Purchased from the Isolated Merchant in Raya Lucaria Academy or selected as a keepsake.' },
  ...
  'Azula Beastman Ashes': { location: 'Dragon Temple', region: 'Crumbling Farum Azula', source: 'Found on a sarcophagus at the lowest floor of the Dragon Temple.' },
  'Kaiden Sellsword Ashes': { location: 'Cliffbottom Catacombs', region: 'Liurnia of the Lakes', source: 'Dropped by the Erdtree Burial Watchdog in Cliffbottom Catacombs.' },
  'Godrick Soldier Ashes': { location: 'Stormhill Shack', region: 'Limgrave', source: 'Found on a body in the graveyard southwest of Stormhill Shack.' },
  'Raya Lucaria Soldier Ashes': { location: "Road's End Catacombs", region: 'Liurnia of the Lakes', source: "Found in a chest behind an illusory wall in Road's End Catacombs." },
  'Leyndell Soldier Ashes': { location: "Sainted Hero's Grave", region: 'Altus Plateau', source: "Found in a corpse in Sainted Hero's Grave." },
  'Radahn Soldier Ashes': { location: 'War-Dead Catacombs', region: 'Caelid', source: 'Found in War-Dead Catacombs.' },
  'Mausoleum Soldier Ashes': { location: 'Deeproot Depths', region: 'Deeproot Depths', source: 'Found by a dead tree in the northern Deeproot Depths.' },
  'Haligtree Soldier Ashes': { location: 'Elphael, Brace of the Haligtree', region: "Miquella's Haligtree", source: 'Found before the large chalice statue overlook in Elphael.' },
  ...
  'Archer Ashes': { location: 'Nokstella, Eternal City', region: 'Nokstella, Eternal City', source: 'Found on a corpse in a balcony in Nokstella.' },
  ...
  'Blackflame Monk Amon': { location: 'Hidden Path to the Haligtree', region: 'Mountaintops of the Giants', source: 'Dropped by the Stray Mimic Tear in the Hidden Path to the Haligtree.' },
  ...
  'Kindred of Rot Ashes': { location: 'Caelid Catacombs', region: 'Caelid', source: 'Dropped by the Cemetery Shade in Caelid Catacombs.' },
  ...
  'Dolores the Sleeping Arrow Puppet': { location: 'Caria Manor', region: 'Liurnia of the Lakes', source: "Dropped by Pidia, Carian Servant, through Seluvis's quest." },
  ...
  'Nightmaiden & Swordstress Puppets': { location: 'Nokstella, Eternal City', region: 'Nokstella, Eternal City', source: 'Found in a chest behind a two-Stonesword-Key fog wall.' },
  ...
  'Stormhawk Deenh': { location: 'Chapel of Anticipation', region: 'Limgrave', source: 'Found on the second floor of the Chapel of Anticipation.' },
  'Nepheli Loux Puppet': { location: 'Caria Manor', region: 'Liurnia of the Lakes', source: "Dropped by Pidia, Carian Servant, through Seluvis's quest." },
  'Man-Fly Ashes': { location: 'Village of Flies', region: 'Abyssal Woods', source: 'Found in the Village of Flies.' },
  'Spider Scorpion Ashes': { location: 'Rauh Ancient Ruins', region: 'Rauh Ruins', source: 'Found on a corpse guarded by a Spider Scorpion in the Rauh Ancient Ruins.' },
  'Fingercreeper Ashes': { location: 'Finger Ruins of Dheo', region: 'Scadu Altus', source: 'Found on a corpse guarded by a large Fingercreeper in Finger Ruins of Dheo.' },
  ...
  "Bloodfiend Hexer's Ashes": { location: 'Rivermouth Cave', region: 'Gravesite Plain', source: 'Dropped by Chief Bloodfiend in Rivermouth Cave.' },
  'Inquisitor Ashes': { location: 'Enir-Ilim', region: 'Enir-Ilim', source: 'Found on a corpse in Enir-Ilim.' },
  'Messmer Soldier Ashes': { location: 'Fort Reprimand', region: 'Gravesite Plain', source: 'Found on a tombstone at the back of Fort Reprimand.' },
  'Black Knight Captain Huw': { location: 'Scorpion River Catacombs', region: 'Abyssal Woods', source: 'Found in a coffin in Scorpion River Catacombs.' },
  'Black Knight Commander Andreas': { location: 'Fog Rift Catacomb', region: 'Scadu Altus', source: 'Found in a coffin in Fog Rift Catacomb.' },
  'Fire Knight Hilde': { location: 'Specimen Storehouse', region: 'Scadu Altus', source: 'Found in a loft near the Storehouse, Loft site of grace.' },
  ...
  'Demi-Human Swordsman Yosh': { location: 'Belurat Gaol', region: 'Gravesite Plain', source: 'Dropped by Demi-Human Swordmaster Onze in Belurat Gaol.' },
  ...
  'Divine Bird Warrior Ornis': { location: 'Rauh Ruins', region: 'Rauh Ruins', source: 'Found in a chest in the Rauh Ruins.' },
  'Taylew the Golem Smith': { location: "Taylew's Ruined Forge", region: 'Rauh Ruins', source: "Awarded for clearing Taylew's Ruined Forge." },
};
